    ...
    const renderContent = () => {
        ...
        return parts.map((part, index) => {
            ...
            if (codeMatch) {
                ...
                const html = typeof (window as any).marked === 'function' ? (window as any).marked(part) : part;
                return <div key={index} className="prose max-w-none" dangerouslySetInnerHTML={{ __html: html }} />;
            }
            return null;
        });
    };
